...
export default function PropertyDetailsPage() {
  ...
  if (!property) return <div className="text-center mt-20 font-semibold text-brand-500">Property not found.</div>;
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="glass-panel p-6 rounded-2xl border-t-4 border-t-primary">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-lg font-bold text-brand-900 dark:text-white">Property Overview</h3>
            </div>
            <div className="space-y-4">
              <div>
                <p className="text-xs font-semibold text-brand-400 uppercase tracking-wider">Total Units</p>
                ...
                <table className="w-full text-left border-collapse min-w-[600px]">
                  <thead>
                    <tr className="bg-white/30 dark:bg-brand-900/30 border-b border-border/50 text-xs uppercase tracking-wider text-brand-500">
                      ...
                      <th className="px-4 py-3 font-semibold text-center">Tenant</th>
                      ...
                      <tr key={u.id} className="hover:bg-brand-50/50 dark:hover:bg-brand-800/50 transition-colors">
                        ...
                        <td className="px-4 py-3 text-center">
                          {u.tenant_name ? (
                            ...
                            <span className="text-brand-400 italic text-sm">Vacant</span>
                          )}
                        </td>
